    ...
    <div className="relative z-10 flex items-center justify-center p-4 py-10">
      <div className="w-full max-w-4xl">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          {/* ฟอร์มล็อกอินเดิม */}
          <div className="bg-white rounded-2xl shadow-2xl border border-white/60 p-8 md:p-10 backdrop-blur-xl">
              ...
              <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-8 text-white shadow-2xl">
                <div className="text-center">
                  ...
                  <p className="text-blue-100 text-lg leading-relaxed">
                    จัดการการจองรถรับ-ส่งได้อย่างง่ายดาย
                    <br />
                    ตรวจสอบสถานะการจองแบบเรียลไทม์
                    <br />
        ...
        <div className="text-center mt-10">
          <p className="text-sm text-gray-500">
            © 2026 Transportation Booking System
          </p>
        </div>
